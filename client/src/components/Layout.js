...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/drawings',       roles: ['admin','user'], icon: 'M4 5a1 1 0 011-1h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 9h16M9 4v16', label: 'Drawing Extraction' },
      { path: '/inspection',     roles: ['admin','user'], icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', label: 'Inspection Reports' },
      { path: '/lessons',        roles: ['admin','user'], icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', label: 'Lessons Learned' },
    ],
  },
  {
    label: 'Procurement & Review',
    items: [
      { path: '/compliance',     roles: ['admin','user'], icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01', label: 'Offer Scrutiny' },
...
const SEARCH_INDEX = [
  ...
  { label:'Drawing Extraction',    path:'/drawings',        breadcrumb:['Document Intelligence','Drawings'],      icon:'📋', keywords:'drawing extraction cable schedule sld single line diagram equipment tag cable tag legend symbol bom coordinates excel mbsre vision', roles:['admin','user'] },
  { label:'Inspection Reports',    path:'/inspection',      breadcrumb:['Document Intelligence','Inspection'],    icon:'📋', keywords:'inspection report converter observation non conformity ncr remark classify material design workmanship installation documentation testing commissioning excel', roles:['admin','user'] },
  { label:'Lessons Learned',       path:'/lessons',         breadcrumb:['Document Intelligence','Lessons'],       icon:'📋', keywords:'lessons learned repository search recurring issues design considerations proactive knowledge defects history', roles:['admin','user'] },
  { label:'Technical Offer Scrutiny', path:'/compliance',   breadcrumb:['Procurement & Review','Offer Scrutiny'], icon:'📋', keywords:'technical offer scrutiny compliance matrix tts sotr tender specification deviation exclusion assumption ambiguity vendor query evaluation', roles:['admin','user'] },
...
const PAGE_TITLES = {
  ...
  '/drawings':        'Drawing Data Extraction',
  '/inspection':      'Inspection Report Converter',
