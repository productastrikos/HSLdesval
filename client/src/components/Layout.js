...
const NAV_SECTIONS = [
  ...
  },
  {
    label: 'AI Assistant',
    items: [
      { path: '/chatbot',        roles: ['admin','user'], icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z', label: 'Rules & Regulations' },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/inspection',     roles: ['admin','user'], icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', label: 'Inspection Report Analytics' },
      { path: '/lessons',        roles: ['admin','user'], icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', label: 'Lessons Learnt' },
    ],
  },
  {
    label: 'Procurement & Generation',
    items: [
      { path: '/compliance',     roles: ['admin','user'], icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01', label: 'Technical Offer Eval.' },
      { path: '/binding',        roles: ['admin','user'], icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', label: 'Binding Data Gap Analysis' },
      ...
      { path: '/design-review',  roles: ['admin','user'], icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2zM12 9v3', label: 'Design Review Assistant' },
    ],
  },
  {
...
const SEARCH_INDEX = [
  ...
  { label:'Rules & Regulations Assistant', path:'/chatbot', breadcrumb:['AI Assistant','Chatbot'],               icon:'📊', keywords:'chatbot ai assistant rules regulations query rule interpret design natural language nlp irs dnv abs iacs imo iec naval follow-up suggestions excel table', roles:['admin','user'] },
  ...
  { label:'Document Comparison',   path:'/compare',         breadcrumb:['Document Intelligence','Comparison'],    icon:'📋', keywords:'document comparison compare two documents differences diff prompt pots binding offer deviation table excel', roles:['admin','user'] },
  ...
  { label:'Inspection Reports Analytics', path:'/inspection', breadcrumb:['Document Intelligence','Inspection'],  icon:'📋', keywords:'inspection reports analytics dashboard equipment wise observation non conformity ncr remark classify status open closed handwritten image ocr sat unsat excel', roles:['admin','user'] },
  { label:'Lessons Learnt Repository', path:'/lessons',     breadcrumb:['Document Intelligence','Lessons'],       icon:'📋', keywords:'lessons learnt learned repository search recurring issues design considerations proactive knowledge defects history detailed remarks', roles:['admin','user'] },
  { label:'Technical Offer Evaluation', path:'/compliance', breadcrumb:['Procurement & Generation','Offer Evaluation'], icon:'📋', keywords:'technical offer evaluation scrutiny compliance matrix tts sotr tender specification deviation exclusion assumption ambiguity vendor query multiple offers vendor wise comparison recommendation seek document', roles:['admin','user'] },
  { label:'Binding Data Gap Analysis', path:'/binding',     breadcrumb:['Procurement & Generation','Binding Data'],   icon:'📦', keywords:'vendor binding data gap analysis review pots purchase order technical specification drawings calculations certificates manuals test procedures missing information extraction', roles:['admin','user'] },
...
const PAGE_TITLES = {
  '/':                'Dashboard',
  '/chatbot':         'Rules & Regulations Engineering Assistant',
  '/history':         'User Interaction History',
  '/documents':       'Document Intelligence',
  '/workspace':       'Workspace Management',
  '/converter':       'Intelligent Document Converter',
  '/compare':         'Document Comparison',
  '/drawings':        'Engineering Drawing Intelligence',
  '/inspection':      'Inspection Report Analytics',
  '/bom':             'BOM & SOTR Generation',
  '/cost':            'Ship Cost Estimation Assistant',
  '/lessons':         'Lessons Learnt Repository',
  '/compliance':      'Technical Offer Evaluation',
  '/binding':         'Binding Data Gap Analysis & Information Extraction',
  '/prebid':          'Pre-Bid Query Generation',
  '/design-review':   'Design Review Assistant for Checklists & Risk Analysis',
